#! /bin/bash
#Pobranie i rozpakowanie źródła Linuxa jeśli trzeba
#Zliczenie ile źródła Linuxa zawierają plików, katalogów
#Ile wszyskich plików źródłowych stanowią pliki o rozszerzeniu *.asm, *.c, *.cpp
#Ile plików było zmodyfikowanych w ostatnim miesiącu, roku, dekadzie
if [ ! -d "linux" ]; then
